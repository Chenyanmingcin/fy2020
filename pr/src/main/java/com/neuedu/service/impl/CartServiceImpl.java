...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse add(Integer userId, Integer productId, Integer count) {
        ...
        if(cart==null){
            ...
            newCart.setChecked(Consts.CartProductCheckEnum.CHECK.getCheck());
    ...
    @Override
    public ServerResponse findCartByIdAndChecked(Integer userId) {
    ...
    private CartVO getCartVO(Integer userId){
        ...
        for(Cart cart:cartList){
            ...
            if(cartProductVO.getProductChecked()== Consts.CartProductCheckEnum.CHECK.getCheck()){
                //已选中
        ...
        //step3: 计算购物车总价格,必须用字符串计算方法，否则会丢失精度
